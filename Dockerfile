...
ARG AIRFLOW_EXTRAS="async,aws,azure,celery,dask,elasticsearch,gcp,kubernetes,mysql,postgres,redis,slack,ssh,statsd,virtualenv,pyodbc"
...
ARG AIRFLOW_CONSTRAINTS_REFERENCE="constraints-1.10.12"
...
ADD https://packages.microsoft.com/config/debian/10/prod.list /etc/apt/sources.list.d/mssql-release.list
